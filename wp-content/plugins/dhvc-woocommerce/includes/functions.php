...
function the_category_page_content(){
...
function the_brand_page_content(){
...
function dhvc_woo_get_product_formatted_name(WC_Product $product){
	...
	return sprintf( __( '%s &ndash; %s', 'woocommerce' ), $identifier, $product->get_title() );
}
...
function dhvc_woo_params(){
	return array(
		...
		array (
				...
				"value" => "1px",
				"description" => __ ( "Enter your custom thumbnail border width . Example: 5px.", DHVC_WOO )
		)
		,
		array (
				"type" => "textfield",
		...
		array (
				"type" => "textfield",
				"class" => "",
				"heading" => __ ( "Add To Cart Text", DHVC_WOO ),
