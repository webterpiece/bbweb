	...
	<div id="PO-tab-container">
		<div id="PO-tab-menu-container">
			<ul id="PO-tab-menu">
				...
				<li id="PO-tab-6"><span class="PO-tab-content">Plugin Search</span></li>
			</ul>
			<div style="clear: both;"></div>
		</div>
		<div id="PO-tab-content">
			...
			<div id="PO-tab-6-content" class="PO-tab-content">
				<h3><label for="PO_search_for_plugin">Plugin Search</label></h3>
				<div id="PO-plugin-search-div" class="stuffbox" style="width: 98%">
				  <div class="PO-loading-container fa fa-spinner fa-pulse"></div>
				  <div class="inside">
