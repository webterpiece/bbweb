...
<div class="yith-ywraq-add-to-quote add-to-quote-<?php echo $product_id ?>" <?php echo $data_variations ?>>
    ...
    <div class="yith_ywraq_add_item_response-<?php echo $product_id ?> yith_ywraq_add_item_response_message <?php echo ( !$exists ) ? 'hide': 'show' ?>" style="display:<?php echo ( !$exists ) ? 'none': 'block' ?>"><?php echo apply_filters( 'ywraq_product_in_list', __('The product added to quote request list!', 'yith-woocommerce-request-a-quote') )?></div>
